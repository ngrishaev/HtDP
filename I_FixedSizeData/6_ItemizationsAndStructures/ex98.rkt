...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname ex98) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (missile-hit-ufo? ufo missile)
  (< (+ (posn-y missile) MISSILE-SIZE) (posn-y ufo))
  )
