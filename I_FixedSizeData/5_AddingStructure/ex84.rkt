...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname ex84) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (edit e ke)
  (cond
   [(and (string? ke) (= (string-length ke) 1) (string<=? ke "z") (string>=? ke "a"))
     (make-editor
   ...
   [else (make-editor "Key pressed" ke)]
   ) 
  )
