...
(check-expect (connect-dots MT triangle-p (make-posn 30 10))
              (scene+line (scene+line (scene+line MT 30 20 30 10 "red") 20 20 30 20 "red") 20 10 20 20 "red"))
...
(define (connect-dots img p last)
  (cond
    [(empty? (rest p)) (scene+line img (posn-x (first p)) (posn-y (first p)) (posn-x last) (posn-y last) "red")]
    [else
     (render-line
